...
# Parse the XML file
tree = ET.parse('temp_dryfruits/xl/worksheets/sheet1.xml')
root = tree.getroot()
...
VALUES ('{name}', {price}, {original_price}, 'Dry Fruits', '{size}', '{image_url}', true, 4.5);"""
    
    sql_statements.append(sql)

# Write to SQL file with proper newlines
with open('insert_dry_fruits.sql', 'w', encoding='utf-8') as f:
    f.write("-- Insert Dry Fruits products into Dry Fruits category\n")
    f.write(f"-- Total products: {len(products)}\n")
    f.write("-- Generated automatically\n")
    f.write("-- Run this script in Supabase SQL Editor\n\n")
    
    f.write("-- STEP 1: Create Dry Fruits category if it doesn't exist\n")
    f.write("INSERT INTO categories (name, description, display_order)\n")
    f.write("VALUES ('Dry Fruits', 'Premium quality dry fruits, nuts, and seeds for healthy snacking', 6)\n")
...
print(f"\n✅ SQL file generated: insert_dry_fruits.sql")
