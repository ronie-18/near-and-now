...
# Parse the XML file
tree = ET.parse('temp_detergents/xl/worksheets/sheet1.xml')
root = tree.getroot()
...
VALUES ('{name}', {price}, {original_price}, 'Detergents', '{size}', '{image_url}', true, 4.5);"""
    
    sql_statements.append(sql)

# Write to SQL file with proper newlines
with open('insert_detergents.sql', 'w', encoding='utf-8') as f:
    f.write("-- Insert Detergents & Fabric Care products into Detergents category\n")
    f.write(f"-- Total products: {len(products)}\n")
    f.write("-- Generated automatically\n")
    f.write("-- Run this script in Supabase SQL Editor\n\n")
    
    f.write("-- STEP 1: Create Detergents category if it doesn't exist\n")
    f.write("INSERT INTO categories (name, description, display_order)\n")
    f.write("VALUES ('Detergents', 'Powerful detergents and fabric care products for clean, fresh clothes', 5)\n")
...
print(f"\n✅ SQL file generated: insert_detergents.sql")
