      ...
      <div className="bg-white rounded-lg shadow-xl w-full max-w-3xl max-h-[90vh] overflow-hidden">
        ...
        <div className="flex flex-col md:flex-row">
          ...
          <div className="w-full md:w-1/2 p-6 overflow-y-auto max-h-[90vh] md:max-h-[600px]">
            ...
            {/* Rating — only shown for products with a real rating */}
            {typeof product.rating === 'number' && product.rating > 0 && (
              <div className="mb-4">
                <StarRating rating={product.rating} reviewCount={product.reviewCount} starSizeClass="h-5 w-5" />
              </div>
            )}
            ...
            <div className="mb-6">
              {inCart ? (
                ...
                <button
                  ...
                  className={`w-full text-white py-3 rounded-md transition-colors flex items-center justify-center font-medium ${
                    product.in_stock
