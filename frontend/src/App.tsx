...
// All routes are static imports — every page ships in the initial bundle so
// navigating between pages never shows a loading fallback. This trades a
// larger upfront download for zero per-navigation loading flicker; the
