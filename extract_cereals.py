...
# Parse the XML file
tree = ET.parse('temp_cereals/xl/worksheets/sheet1.xml')
root = tree.getroot()
...
VALUES ('{name}', {price}, {original_price}, 'breakfast-cereals', '{size}', '{image_url}', true, 4.5);"""
    
    sql_statements.append(sql)

# Write to SQL file with proper newlines
with open('insert_breakfast_cereals.sql', 'w', encoding='utf-8') as f:
    f.write("-- Insert Breakfast Cereals products into breakfast-cereals category\n")
    f.write(f"-- Total products: {len(products)}\n")
    f.write("-- Generated automatically\n")
    f.write("-- Run this script in Supabase SQL Editor\n\n")
    
    f.write("-- STEP 1: Create breakfast-cereals category if it doesn't exist\n")
    f.write("INSERT INTO categories (name, description, display_order)\n")
    f.write("VALUES ('breakfast-cereals', 'Start your day right with healthy breakfast cereals, oats, and muesli', 2)\n")
...
print(f"\n✅ SQL file generated: insert_breakfast_cereals.sql")
