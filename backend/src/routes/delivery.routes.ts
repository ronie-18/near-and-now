...
router.get('/partners/profile-change-requests', requireAdmin, requirePermission('profile_change_requests.view'), deliveryController.listRiderProfileChangeRequests.bind(deliveryController));
