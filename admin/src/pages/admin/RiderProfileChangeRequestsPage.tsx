 ...
 * edits from the rider app's profile screen). Previously these edits applied
 * immediately with zero admin visibility — mirrors
    ...
    <AdminLayout>
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold text-gray-900">Rider Profile Change Requests</h1>
            ...
            {requests.map((req) => (
              <div key={req.id} className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                <div className="flex items-start justify-between mb-4">
                  <div>
                    <h3 className="text-lg font-bold text-gray-900">{req.rider_name || 'Unknown rider'}</h3>
