...
# Parse the XML file
tree = ET.parse('temp_chocolates/xl/worksheets/sheet1.xml')
root = tree.getroot()
...
VALUES ('{name}', {price}, {original_price}, 'chocolates-and-candies', '{size}', '{image_url}', true, 4.5);"""
    
    sql_statements.append(sql)

# Write to SQL file with proper newlines
with open('insert_chocolates_and_candies.sql', 'w', encoding='utf-8') as f:
    f.write("-- Insert Chocolates & Candies products into chocolates-and-candies category\n")
    f.write(f"-- Total products: {len(products)}\n")
    f.write("-- Generated automatically\n")
    f.write("-- Run this script in Supabase SQL Editor\n\n")
    
    f.write("-- STEP 1: Create chocolates-and-candies category if it doesn't exist\n")
    f.write("INSERT INTO categories (name, description, display_order)\n")
    f.write("VALUES ('chocolates-and-candies', 'Indulge in delicious chocolates, candies, and sweet treats', 3)\n")
...
print(f"\n✅ SQL file generated: insert_chocolates_and_candies.sql")
